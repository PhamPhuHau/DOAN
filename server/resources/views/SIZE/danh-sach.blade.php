...
@section('chon')
                    ...
                    <a href="/danh-sach-san-pham" class="nav-item nav-link "><i class="fa fa-laptop me-2"></i>SẢN PHẨM</a>
                    ...
                    <a href="/danh-sach-size" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>SIZE</a>
